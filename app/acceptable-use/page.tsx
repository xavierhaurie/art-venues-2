...
export default function AcceptableUsePage() {
  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <p>This acceptable use policy covers the products, services, and technologies (collectively referred to as the "Products") provided by Mountaintop Software Builders DBA Mini List under any ongoing agreement. It’s designed to protect us, our customers and the general Internet community from unethical, irresponsible and illegal activity.</p>
        <p>Mountaintop Software Builders DBA Mini List customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities.</p>
        <p>This policy was last reviewed on November 19, 2025.</p>
        ...
        <h3>Unauthorized Use of Mountaintop Software Builders DBA Mini List Property</h3>
        <p>We prohibit the impersonation of Mountaintop Software Builders DBA Mini List, the representation of a significant business relationship with Mountaintop Software Builders DBA Mini List, or ownership of any Mountaintop Software Builders DBA Mini List property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage or user trust.</p>
